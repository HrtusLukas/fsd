...
const Solutions = () => {
  return (
    <div className="lg:w-[1200px] lg:h-[350px] h-auto w-[100vw] lg:bg-secondary bg-transparent  lg:border-[0.5px] lg:fixed border-primary border-solid flex lg:flex-row flex-col lg:rounded-[20px] lg:overflow-visible overflow-y-auto max-h-[72vh]">
        ...
        return (
          <div key={id} className="h-[100%] w-[100%] m-auto flex flex-col items-baseline py-6 px-10 ">
            ...
            <div className="flex flex-col">
              <Link to={""} className="text-primary text-[17px] mb-1  border-b-[0.5px] border-primary  hover:font-[500] hover:border-background hover:border-b-[1px]">
                {solution1}
              </Link>
              <Link to={""} className="text-primary text-[17px] mb-1  border-b-[0.5px] border-primary  hover:font-[500] hover:border-background hover:border-b-[1px]">
                {solution2}
