  ...
  return (
    <div className="pt-[100px] w-[100vw] lg:w-[96.5vw] h-auto bg-transparent m-0 lg:mx-[20px] flex flex-col lg:flex-row">
      <div className="w-full lg:w-[50%] flex flex-col text-primary gap-y-10 mt-[5%] px-[7%]">
        ...
        <div>
          <p className="text-2xl mb-2">Where We Are Located</p>
          <p>
            FSD s.r.o
            <br />
            Vyšná Korňa 760
        ...
        <div>
          <p className="text-2xl mb-2">Billing Information</p>
          <p>
            Company ID: <span className="text-lg font-[500]">47394625</span>
          </p>
          <p>
            Tax ID: <span className="text-lg font-[500]">2023860234</span>
          </p>
          <p>
            VAT ID: <span className="text-lg font-[500]">SK2023860234</span>
          </p>
        </div>
